      ...
      .then((data) => {
        ...
        if (data.data) {
          const formattedData = data.data.map((list) => ({
            ...list,
            status: (list.status ? 'ACTIVE' : 'INACTIVE').toUpperCase(),
          }));
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          ...
          <CModal visible={modalOpen} onClose={closeModal} backdrop="static">
            <CModalHeader>
              <CModalTitle>Add New Diagnosis List</CModalTitle>
            </CModalHeader>
            <CModalBody>
          ...
          <CModal visible={editModalOpen} onClose={closeEditModal} backdrop="static">
            <CModalHeader>
              <CModalTitle>Edit Diagnosis List</CModalTitle>
            </CModalHeader>
            <CModalBody>
              {error && <CAlert color="danger">{error}</CAlert>}
              {formLoading && <CSpinner color="primary" />}
          ...
          <CModal visible={isActivateDialogOpen} onClose={() => setIsActivateDialogOpen(false)} backdrop="static">
            <CModalHeader>
          ...
          <CModal visible={isDeactivateDialogOpen} onClose={() => setIsDeactivateDialogOpen(false)} backdrop="static">
            <CModalHeader>
